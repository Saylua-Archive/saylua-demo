import { addCoinsFunc, adoptFunc, randomCompanion } from '../encounterFuncs';
...
export default class CompCash extends Encounter {
  get mainText() {
    ...
    if (this._state.activeCompanion) {
      ...
      return `A wild ${newComp.species}! You can tell by the look on their face that they'd love to
